...
public class Configuracao {
	...
	public Configuracao(Long id, Empresa empresa, Campeonato campeonato, Integer pontos_cravada,
						Integer pontos_acerto, Integer pontos_erro)
	{
		...
		System.out.println(id + " " + empresa + " " + campeonato + " " + pontos_cravada + " " +
				pontos_acerto + " " + pontos_erro);
	}
	
	public Configuracao(Empresa empresa, Campeonato campeonato, Integer pontos_cravada,
						Integer pontos_acerto, Integer pontos_erro)
	{
		super();
		this.empresa = empresa;
	...
	public String toString() {
		return "Configuracao [id=" + id + ", empresa=" + empresa + ", campeonato=" + campeonato + ","
