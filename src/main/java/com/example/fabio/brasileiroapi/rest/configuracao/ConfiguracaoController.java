...
import com.example.fabio.brasileiroapi.model.repository.ConfiguracaoRepository;
...
public class ConfiguracaoController {
	...
	){ System.out.println(empresa + " - " + campeonato);
		return repository
					.buscarPorEmpresaCampeonato(empresa, campeonato , pageable)
					.map( ConfiguracaoFormRequest::fromModel );
	}
}