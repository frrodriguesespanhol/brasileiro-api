...
import com.example.fabio.copaapi.model.repository.JogoRepository;
...
public class JogoController {
	...
	public Page<JogoFormRequest> getLista(
		...
		@RequestParam(value="sel1", required= false) String sel1,
		Pageable pageable
		
	){ System.out.println(sel1 + " - " + fase);
		return repository
					.buscarPorFaseSelecao(fase, sel1 , pageable)
					.map( JogoFormRequest::fromModel );
	}
}